...
export PATH=/opt/gradle/bin\:/opt/maven/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/local/go/bin\:/usr/local/node_packages/node_modules/.bin\:/usr/local/rvm/bin\:/home/p_budhwar/.gems/bin\:/usr/local/rvm/bin\:/home/p_budhwar/gopath/bin\:/google/gopath/bin\:/google/flutter/bin\:/usr/local/nvm/versions/node/v22.18.0/bin
